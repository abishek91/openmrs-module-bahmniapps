...
.controller('PatientsListController', ['$scope', '$window', 'patientService', '$rootScope', 'appService', 'spinner', '$stateParams',
    function ($scope, $window, patientService, $rootScope, appService, spinner, $stateParams) {
        var initialize = function () {
            $rootScope.retrospectiveEntry = $rootScope.retrospectiveEntry || {};
            $rootScope.retrospectiveEntry.encounterDate = $rootScope.retrospectiveEntry.encounterDate ? $rootScope.retrospectiveEntry.encounterDate : Bahmni.Common.Util.DateUtil.getDateWithoutTime(Bahmni.Common.Util.DateUtil.now());
